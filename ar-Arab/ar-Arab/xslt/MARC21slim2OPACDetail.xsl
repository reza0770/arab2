...
<xsl:stylesheet version="1.0"
 ...
 <xsl:when test="$materialTypeLabel='Music'">ألبوم موسيقي</xsl:when>
 ...
 <xsl:text>أظهر المجلدات</xsl:text>
 </a>
 </span>
 </xsl:if>
 ...
 <span class="results_summary set"><span class="label">اضبط:</span>
 ...
 <xsl:with-param name="label">الطبعات: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>

 <xsl:if test="marc:datafield[@tag=250]">
 <span class="results_summary edition"><span class="label">الطبعات: </span>
 ...
 <span class="results_summary isbn"><span class="label">ردمك: </span>
 ...
 <span class="results_summary uniform_titles"><span class="label">العناوين الموحدة: </span>
...
<!-- DDC classification -->
 ...
 <span class="label">تصنيف DDC:</span>
...
<!-- Image processing code added here, takes precedence over text links including y3z text -->
 ...
 <span class="results_summary online_resources"><span class="label">مصادر على الخط المباشر</span>
 ...
 <xsl:when test="@ind1=1"><xsl:text>الاستعراض: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>النطاق والمحتوى: </xsl:text></xsl:when>
 <xsl:when test="@ind1=3"><xsl:text>مستخلص:</xsl:text></xsl:when>
 <xsl:when test="@ind1=4"><xsl:text>محتوى النصيحة: </xsl:text></xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">المتابعة:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">متابعة الجزء</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">تحل محل:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">استبدلت في الجزء:</span>
 </xsl:when>
 ...
 <xsl:when test="@ind2=1">
 <span class="label">متابعة الجزء من قبل:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 ...
 <xsl:otherwise>المساهم (المساهمين):</xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 ...
 <xsl:otherwise><xsl:attribute name="typeof">المنظمة</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <span property="name">
 <xsl:choose>
