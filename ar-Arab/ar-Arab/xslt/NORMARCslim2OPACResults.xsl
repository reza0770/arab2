...
<xsl:stylesheet version="1.0"
 ...
 <xsl:choose>
 <xsl:when test="$field019b='b' or $field019b='k' or $field019b='l' or $leader6='b'">الإثنين</xsl:when>
 ...
 <xsl:when test="$field019b='c' or $field019b='d' or contains($field019b,'da') or contains($field019b,'db') or contains($field019b,'dc') or contains($field019b,'dd') or contains($field019b,'dg') or contains($field019b,'dh') or contains($field019b,'di') or contains($field019b,'dj') or contains($field019b,'dk') or $leader6='c' or $leader6='d' or $leader6='i' or $leader6='j'">موسيقى</xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="$leader7='a' or $leader7='c' or $leader7='m' or $leader7='p'">الإثنين</xsl:when>
 ...
 <xsl:if test="contains($field019b,'ab')"> أطلس</xsl:if>
 ...
 <xsl:if test="$field019b='e'"> الفيلم والفيديو</xsl:if>
 <xsl:if test="contains($field019b,'ec')"> Filmspole</xsl:if>
 <xsl:if test="contains($field019b,'ed')"> فيديو كاسيت</xsl:if>
 ...
 <xsl:if test="contains($field019b,'gb')"> سلة</xsl:if>
 ...
 <xsl:if test="contains($field019b,'ib')"> -ميكروفيلم</xsl:if>
 ...
 <xsl:if test="$controlField007-01='b'">أطلس</xsl:if>
 ...
 <xsl:if test="$controlField007-01='t'">خطة</xsl:if>
 ...
 <xsl:if test="$controlField007-01='d'">سلة</xsl:if>
 ...
 <xsl:if test="$controlField007-01='n'">Fjerntilgang (على الخط)</xsl:if>
 <xsl:if test="$controlField007-01='o'">Optisk plate</xsl:if>
 <xsl:if test="$controlField007-01='z'">وسائط تخزين أخرى</xsl:if>
 </xsl:if>
 ...
 <xsl:if test="$controlField007-01='t'">شفافيات</xsl:if>
 ...
 <xsl:if test="$controlField007-01='d'">-ميكروفيلم</xsl:if>
 ...
 <xsl:if test="$controlField007-01='c'">ملصق</xsl:if> <!-- Originalt kunstverk -->
 <xsl:if test="$controlField007-01='d'">رسم</xsl:if> <!-- Originalt kunstverk -->
 ...
 <xsl:if test="$controlField007-01='q'">رمز كورت</xsl:if>
 <xsl:if test="$controlField007-01='r'">Kunstreproduksjon</xsl:if>
 <xsl:if test="$controlField007-01='s'">بطاقة بريدية</xsl:if>
 ...
 <xsl:if test="$controlField007-01='q'">اللفة (pianorull/orgelrull)</xsl:if>
 <xsl:if test="$controlField007-01='s'">Lydkassett</xsl:if>
 <xsl:if test="$controlField007-01='t'">Lydbånd</xsl:if>
 <xsl:if test="$controlField007-01='w'">سلك </xsl:if>
 ...
 <xsl:if test="$controlField007-01='g'">لفافة ورقية</xsl:if>
 <xsl:if test="$controlField007-01='p'">Mikroskopdia</xsl:if>
 <xsl:if test="$controlField007-01='q'">Modell</xsl:if>
 <xsl:if test="$controlField007-01='r'">مجسم طبيعي</xsl:if>
 ...
 <xsl:if test="$controlField007-01='f'">فيديو كاسيت</xsl:if>
...
> <xsl:when test="marc:datafield[@tag=100] or marc:datafield[@tag=110] or marc:datafield[@tag=111] or marc:datafield[@tag=700] or marc:datafield[@tag=710] or marc:datafield[@tag=711]">
 ...
 <span class="results_summary analytics"><span class="label">مداخل تحليلية: </span>
 <a>
 <xsl:choose>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:when test="$typeOf008='FV'"><img alt="الفيلم والفيديو" src="/opac-tmpl/lib/famfamfam/VM.png" title="الفيلم والفيديو" /> الفيلم والفيديو</xsl:when>
 ...
 <span class="label">; تنسيق:</span><xsl:copy-of select="$physicalDescription"></xsl:copy-of>
 </xsl:if>
 ...
 <xsl:when test="contains($controlField008-24,'i')"> يسجل</xsl:when>
 ...
 <xsl:when test="contains($controlField008-24,'o')"> ملاحظات</xsl:when>
 ...
 <xsl:when test="$controlField008-26='b'">البرنامج</xsl:when>
 <xsl:when test="$controlField008-26='c'">Grafiske data</xsl:when>
 <xsl:when test="$controlField008-26='d'">نص</xsl:when>
 <xsl:when test="$controlField008-26='e'">Bibliografiske data</xsl:when>
 <xsl:when test="$controlField008-26='f'">خط</xsl:when>
 <xsl:when test="$controlField008-26='g'">لفافة ورقية</xsl:when>
 ...
 <xsl:when test="$controlField008-33='r'">روماني</xsl:when>
 ...
 <xsl:when test="$controlField008-33='a'">مقتطفات</xsl:when>
 ...
 <xsl:if test="contains($controlField008-30-31,'d')">دراما</xsl:if>
 <xsl:if test="contains($controlField008-30-31,'e')">مقالات</xsl:if>
...
,1)='q']">
 ...
 <xsl:when test="$controlField008-22='f'">متخصص</xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="$controlField008-22='a'">Voksne;</xsl:when>
 <xsl:when test="$controlField008-22='b'">صور متحركة للبالغين؛</xsl:when>
 <xsl:when test="$controlField008-22='j'">Barn og ungdom;</xsl:when>
 ...
 <xsl:when test="$controlField008-22='y'">صور متحركة للطلاب من المستوى .6 إلى .7؛</xsl:when>
...
<!-- Links found in 856$u. This is copied verbatim from MARC21 detail view and should be identical to code in NORMARC detail view (except for $Show856uAsImage='Results'). -->
 ...
 <span class="results_summary online_resources"><span class="label">موارد على الانترنت:</span>
 ...
 <xsl:otherwise>
 <xsl:text>انقر هنا للوصول إلى الانترنت</xsl:text>
 </xsl:otherwise>
 </xsl:choose>
 </a>
 <xsl:choose>
...
<span class="results_summary">
 ...
 <xsl:choose>
 <xsl:when test="count(key('item-by-status', 'available'))=0 and count(key('item-by-status', 'reference'))=0">لا توجد مواد متاحة</xsl:when>

 <xsl:when test="count(key('item-by-status', 'available'))>0">
 <span class="available">
 <strong><xsl:text>المواد المتاحة للإعارة:</xsl:text></strong>
...
<xsl:choose><xsl:when test="position()=last()"><xsl:text>. </xsl:text></xsl:when><xsl:otherwise><xsl:text>, </xsl:text></xsl:otherwise></xsl:choose>
 ...
 <span class="available">
 <strong><xsl:text>المواد المتاحة للمرجعية:</xsl:text></strong>
