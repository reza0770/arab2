...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="spanclass">ضبط_المستوى</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">464</xsl:with-param>
 <xsl:with-param name="label">مستوى تحليلي- جزئي</xsl:with-param>
 <xsl:with-param name="spanclass">مستوى_تحليل_القطعة</xsl:with-param>
 </xsl:call-template>
 ...
 <xsl:with-param name="spanclass">عنوان_موحد</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">503</xsl:with-param>
 <xsl:with-param name="label">الرؤوس الموحدة التقليدية</xsl:with-param>
 <xsl:with-param name="spanclass">الرأس_التقليدي_الموحد</xsl:with-param>
 </xsl:call-template>
 ...
 <span class="label">لاحظ المنشأ:</span>
 ...
 <span class="label">الإطروحات:</span>
 ...
 <span class="label">سِجل الدورية SUDOC</span>
 ...
 <span class="label">مصادر على الخط المباشر:</span>
